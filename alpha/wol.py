...
def sanJose(external):
	...
	if(wol == 0):
		...
		send_magic_packet("18:03:73:BD:F7:BC")
	elif(wol == 2):
		print("Turning on DESKTOP-HP2020 via WOL")
		send_magic_packet("2C:27:D7:1D:00:C5")
	elif(wol == 3):
		print("Turning on DESKTOP-TD2015 via WOL")
		send_magic_packet("D8:CB:8A:3C:3A:FF")
	elif(wol == 4):
		print("Turning on LAPTOP-MSI via WOL")
		send_magic_packet("00:D8:61:85:A0:6B")
	elif(wol == 5):
		print("Turning on WORKSTATION-TD2020 via WOL")
		send_magic_packet("2C:F0:5D:71:EF:47")
	elif(wol == 6):
                print("Turning on DESKTOP-SC2021 via WOL")
                send_magic_packet("04:42:1A:0E:06:93")
	elif(wol == 7):
		print("Turning on TimMini via WOL")
		send_magic_packet("14:98:77:6F:B1:88")
	elif(wol == 8):
...
def orange(external):
        ...
        if(wol == 0):
                ...
                send_magic_packet("F0:2F:74:F3:5E:95")
        elif(wol == 4):
                print("Turning on All Computers via WOL")
                send_magic_packet("00:D8:61:85:A0:6B")
                send_magic_packet("04:42:1A:0E:06:93")
